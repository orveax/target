...
<section class="portfolio-app" :dir="isAr?'rtl':'ltr'">
  <div class="portfolio-company-grid">
    <button v-for="(c,ci) in companies" :key="c.id" type="button" class="company-tile" :class="{active:store.companyIndex===ci}" @click="store.selectCompany(ci)">
